...
const EditThread = () => {
    ...
    useEffect(() => {
        axios.get(import.meta.env.VITE_APP_API_URL+`/threads/${id}`)
            .then(response => {
    ...
    const handleSubmit = (event: { preventDefault: () => void; }) => {
        ...
        axios.put(import.meta.env.VITE_APP_API_URL+`/threads/${id}`, thread)
    ...
    return (
        <div  className="p-4">
            ...
            <form onSubmit={handleSubmit} className="p-4">
                ...
                <button type="submit" className="px-4 py-2 text-white bg-blue-500 hover:bg-blue-600 rounded">Update Thread</button>
            </form>
